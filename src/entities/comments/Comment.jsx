        ...
        <div className={styles.comment_wrapper}>
            ...
            <div className={styles.comment_wrapper_rightSide}>
                ...
                <div className={styles.comment_wrapper_rightSide_rating}>
                    <img src={Images.starUnliked} alt=""/>
                    <img src={Images.starUnliked} alt=""/>
                    <img src={Images.starUnliked} alt=""/>
                    <img src={Images.starUnliked} alt=""/>
                    <img src={Images.starUnliked} alt=""/>
            ...
            <div className={styles.comment_wrapper_rightSide_text}>
                <p>Lorem ipsum dolor sit amet consectetur. Et quam dis morbi tellus quis non. Sit in praesent tristique
                    sodales lectus vitae posuere pellentesque.</p>
            </div>
        </div>
